    ...
    return (
        <div className={styles.instructionContainer}>
            ...
            <div 
                ...
                <p className={styles.fifthText}>1. Натиснить на кнопку "Створити нову компанію".</p>
                <p className={styles.sixText}>2. Введіть кількість участників, придуймайте пароль та натиснить кнопку "Далі".</p>
                <p className={styles.seventhText}>3. В кожному полі введіть імʼя кожного з участників.</p>
                ...
                <p className={styles.ninethText}>4. Введіть своє імʼя і натиснить кнопку "Стати таємним Сантою".</p>
                <p className={styles.tenText}>5. Після цього ви побачете імʼя людини, якої ви будете дарувати подарунок, список учасників,
                    а також номер вашої компанії і пароль.
                </p>
                <p className={styles.elevenText}>6. Передайте номер і пароль вашої компанії усім участником зі списка.</p>
                <p className={styles.twelveText}>Зверніть увагу, участник має заходити саме под таким імʼям, яким його зазначили у списку.
                ...
                <p className={styles.fourteenText}>1. Введіть номер і пароль вашої компнаії та натиснить кнопку "Далі".</p>
                <p className={styles.seventeenText}>2. Введіть своє імʼя саме так як було вказано людиною, яка створювала список участиків, та натисніть кнопку "Стати таємним Сантою".</p>
